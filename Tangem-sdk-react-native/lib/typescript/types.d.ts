...
export declare enum LinkedTerminalStatus {
    /**
...
declare type DerivationPath = string;
/**
...
export declare type NFCStatusResponse = {
    enabled: boolean;
    support: boolean;
};
/**
 * Event's listeners
 */
export declare type Events = 'NFCStateChange';
...
export declare type FileToWrite = OwnerFile | UserFile;
export declare type ReadFilesResponse = {
    files: File[];
};
...
export interface TangemSdk {
    ...
    signHash(hashes: Data, walletPublicKey: Data, cardId: string, hdPath?: DerivationPath, initialMessage?: Message): Promise<[SignHashResponse]>;
    signHashes(hash: Data[], walletPublicKey: Data, cardId: string, hdPath?: DerivationPath, initialMessage?: Message): Promise<[SignHashesResponse]>;
    createWallet(curve: EllipticCurve, cardId: string, initialMessage?: Message): Promise<CreateWalletResponse>;
    purgeWallet(walletPublicKey: Data, cardId: string, initialMessage?: Message): Promise<SuccessResponse>;
    setAccessCode(accessCode: String, cardId: string, initialMessage?: Message): Promise<SuccessResponse>;
    setPasscode(passcode: String, cardId: string, initialMessage?: Message): Promise<SuccessResponse>;
    resetUserCodes(cardId: string, initialMessage?: Message): Promise<SuccessResponse>;
    readFiles(readPrivateFiles?: boolean, fileName?: string, walletPublicKey?: Data, cardId?: string, initialMessage?: Message): Promise<ReadFilesResponse>;
    writeFiles(files: FileToWrite[], cardId?: string, initialMessage?: Message): Promise<WriteFilesResponse>;
    deleteFiles(indices?: number[], cardId?: string, initialMessage?: Message): Promise<SuccessResponse>;
    changeFilesSettings(changes: FileSettingsChange, cardId?: String, initialMessage?: Message): Promise<SuccessResponse>;
    prepareHashes(cardId: string, fileData: Data, fileCounter: number, fileName?: string, privateKey?: Data): Promise<PrepareHashesResponse>;
    runJSONRPCRequest(JSONRPCRequest: object, cardId?: string, initialMessage?: Message): Promise<any>;
